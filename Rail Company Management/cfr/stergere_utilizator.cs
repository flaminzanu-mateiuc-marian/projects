...
namespace cfr
{
    public partial class stergere_utilizator : Form
    {
        ...
        private void stergere_utilizator_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandText = "delete from utilizatori where NumePrenume=('" + dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString() + "')";
                cmd.ExecuteNonQuery();
